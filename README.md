Let's break down the concepts of subspace, basis, dimension, and span using the vector \(\mathbf{v} = \begin{pmatrix} 3 \\ 4 \end{pmatrix}\) in the context of \(\mathbb{R}^2\).
